...
var token = "eyJhbGciOiJIUzUxMiJ9.eyJzdWIiOiIxIiwiaWF0IjoxNTY4ODEzMDE0LCJleHAiOjE1Njk0MTc4MTR9.TQ_7goXC2bQ0fbKw9wspjUjGD5t5mvDkOmy2XrAZ5AxyJm9Ntqjs8qnUYH10a04GrM8KCf7wLWznjGeNRFTUrw";
var headers = {};
...
function connect(event) {
  ...
  if (username) {
    ...
    var socket = new SockJS('/ws', null, {headers: {'Authorization': token}});
...
function enterRoom(newRoomId) {
  ...
  stompClient.subscribe(`/app/messageHistory/${roomId}`, function(message) {
