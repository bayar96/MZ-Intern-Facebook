...
import com.pgs.post.client.AuthClient;
import com.pgs.post.domain.Comment;
import com.pgs.post.domain.CommentLike;
import com.pgs.post.domain.Post;
import com.pgs.post.payload.UserInfo;
import com.pgs.post.repository.CommentLikeRepository;
import com.pgs.post.repository.CommentRepository;
import com.pgs.post.repository.PostRepository;
...
public class CommentServiceImpl implements CommentService {
    ...
    public void likeComment(Long postId, Long commentId) {
        ...
        CommentLike commentLike = new CommentLike(null, commentId, userInfo.getId());
