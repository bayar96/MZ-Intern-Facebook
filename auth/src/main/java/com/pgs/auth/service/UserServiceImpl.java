...
public class UserServiceImpl implements UserService {
    ...
    public void inviteUser( Long eventId, Long userId) {
        ...
        if (inviteRepository.findByEventIdAndInvitedUser_Id(eventId, userId).isPresent()) {
            return;
        }
    ...
    public void deleteInvite(Long userId, Long eventId) {
        ...
        Invite invite = inviteRepository.findByEventIdAndInvitedUser_Id(eventId, userId)
                .orElseThrow(() -> new EntityNotFoundException("Invite with id - " + eventId + " not found!"));
        fromDB.getInvitedEvents().remove(invite);
